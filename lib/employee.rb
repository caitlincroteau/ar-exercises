class Employee < ActiveRecord::Base
  ...
  validates :hourly_rate, numericality: { :only_integer => true, :greater_than_or_equal_to => 40, :less_than_or_equal_to => 200, :message => "must be an integer between 40 and 200" }
